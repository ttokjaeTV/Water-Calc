...
#
# 아래 앵커는 미국 11,974 + 국내 3,896 = 15,870종목의 실제 분포에서 뽑았다
# (2026-09-04 기준). 분위수를 9단계 등급 폭에 맞춰 배치한다.
#
# 처음에는 국내 493종목 하루치로 잡았는데, 그 표본의 중앙값이 61이고
# 미국 전종목 중앙값은 55.5여서 5.5포인트가 어긋났다. 그 결과 미국 종목이
# 아래로 쏠려 10~19점('강력익절') 한 칸에 19.2%가 몰렸다.
# 두 시장을 합친 분포로 다시 잡아 미국 최대집중을 14.0%로 낮췄다.
#
# 시장별로 따로 잡지 않는 이유: 그러면 미국 60점과 국내 60점이 다른 의미가 되어
# 비교가 불가능해진다. 시장 간 온도차는 보존되는 게 맞다.
#
# 다시 뽑으려면 배포된 indicators_us.csv + indicators_kr.csv 의 raw_score 를
# 합쳐 분위수(2/6/14/28/45/62/78/90/97%)를 [3,15,25,35,50,65,75,85,95]에 맞춘다.
SCORE_STRETCH = [(0, 0), (31, 3), (35, 15), (40, 25), (47, 35), (55, 50),
                 (61, 65), (66, 75), (72, 85), (78, 95), (100, 100)]
